...
public class FileTypeHistogram {
  ...
  private enum TYPES {
    UNKNOWN, PART_R, PART_M, PARQUET, AVRO, SNAPPY, GZ, LOG, TXT, _SUCCESS, JSON, XML,
    DAT, INDEX, ORC, JAR, ZIP, DTDONE, JHIST
  }
  ...
  private static final Function<String, Boolean> success_pattern =
      s -> s.equals("_SUCCESS");
  private static final Function<String, Boolean> txt_pattern =
      s -> s.endsWith(".txt");
  private static final Function<String, Boolean> log_pattern =
      s -> s.endsWith(".log");
  private static final Function<String, Boolean> avro_pattern =
      s -> s.endsWith(".avro");
  private static final Function<String, Boolean> snappy_pattern =
      s -> s.endsWith(".snappy");
  private static final Function<String, Boolean> parquet_pattern =
      s -> s.endsWith(".parquet");
  private static final Function<String, Boolean> gz_pattern =
      s -> s.endsWith(".gz");
  private static final Function<String, Boolean> json_pattern =
      s -> s.endsWith(".json");
  private static final Function<String, Boolean> xml_pattern =
      s -> s.endsWith(".xml");
  private static final Function<String, Boolean> dat_pattern =
      s -> s.endsWith(".dat");
  private static final Function<String, Boolean> index_pattern =
      s -> s.endsWith(".index");
  private static final Function<String, Boolean> orc_pattern =
      s -> s.endsWith(".orc");
  private static final Function<String, Boolean> jar_pattern =
      s -> s.endsWith(".jar");
  private static final Function<String, Boolean> zip_pattern =
      s -> s.endsWith(".zip");
  private static final Function<String, Boolean> dtdone_pattern =
      s -> s.endsWith(".dtdone");
  private static final Function<String, Boolean> jhist_pattern =
      s -> s.endsWith(".jhist");
